...
const countThem = () => {
  ...
  let total = pokemons.length;
  console.log(`I have ${total} pokemons.`);
...
const orderThem = () => {
  ...
  let orderPokemons = pokemons.sort();
...
const flipThem = () => {
  // reverse the order of the pokemons
  let reversePokemons = pokemons.reverse();
  console.log(reversePokemons);
};
flipThem();
console.log("----");
...
const onlyTheBs = () => {
  ...
  const startWithB = pokemons.filter((pokemon) => pokemon.startsWith('B'));
...
const notTheCs = () => {
  // remove all pokemons that starts with C
  const removeC = pokemons.filter(c => !c.includes('C'));
  console.log(removeC);
};
notTheCs();
console.log("----");
...
// console.log("----");
  const addPokemon = pokemons.push('Eeve');
  console.log(pokemons);
};
//catchPokemon();
...
// console.log("----");
    return pokemons.reduce((max,name)=>{
